...
if [[ "$1" == bench* ]]; then
    echo "benchmarks are not included"
    # echo "BENCHMARKING..."
    # echo $CC $CFLAGS ../xv.c ../json.c bench.c -lm 
    # $CC $CFLAGS ../xv.c ../json.c bench.c -lm 
    # ./a.out $@
else
    ...
    for f in *; do 
        ...
        $CC $CFLAGS -o $f.test ../xv.c ../json.c ../ryu.c -lm $f
        if [[ "$WITHCOV" == "1" ]]; then
